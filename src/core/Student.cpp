...
void Student::setSex(int newSex) { sex = newSex; }
void Student::setAge(int newAge) { age = newAge; }
void Student::setDormNumber(int newDormNumber) { dorm_number = newDormNumber; }
void Student::setPhoneNumber(const std::string &newPhoneNumber) { phone_number = newPhoneNumber; }
